    ...
    <main>
        <div class="container">
            ...
            <div class="article-container" id="articles-grid">
                ...
                <!-- Article 8 -->
                <div class="article-card" data-category="prevention">
                    <img src="https://cdn-endpoint-prev.azureedge.net/healthy-heart/2019/08/Diabetes-iStock-1166082475-e1565871768775-scaled.jpg" alt="Diabetes Prevention" class="article-image">
                    <div class="article-content">
                        <div class="article-meta">
                            <span class="article-date">Apr 5, 2025</span>
                            <span class="article-category">Prevention</span>
                ...
                <!-- Article 10 -->
<div class="article-card" data-category="prevention">
    <img src="https://familiestogetheroc.org/wp-content/uploads/2023/01/hands-holding-red-heart-with-stethoscope-heart-health-health-insurance-concept-scaled.jpg" alt="Heart Health" class="article-image">
    <div class="article-content">
        <div class="article-meta">
            <span class="article-date">Apr 3, 2025</span>
            <span class="article-category">Prevention</span>
        </div>
        <h3 class="article-title">Heart Health: <br>Prevention Strategies</h3>
        <p class="article-snippet">Cardiovascular disease remains a leading cause of death worldwide. Learn evidence-based approaches to keeping your heart healthy and reducing risk factors.</p>
        <a href="https://pubmed.ncbi.nlm.nih.gov/33309175" target="_blank" class="btn-read">Read Article</a>
    </div>
</div>

<!-- Article 11 -->
<div class="article-card" data-category="fitness">
    <img src="https://files.nccih.nih.gov/files/Woman-performing-yoga-square-medium.jpg" alt="Yoga Benefits" class="article-image">
    <div class="article-content">
        <div class="article-meta">
            <span class="article-date">Apr 2, 2025</span>
            <span class="article-category">Fitness</span>
        </div>
        <h3 class="article-title">Yoga Benefits for Physical and Mental Wellbeing</h3>
        <p class="article-snippet">More than just stretching, yoga combines physical postures, breathing exercises, and meditation. Discover how this ancient practice can improve your overall health.</p>
        <a href="https://www.nccih.nih.gov/health/yoga-what-you-need-to-know" target="_blank" class="btn-read">Read Article</a>
    </div>
</div>

<!-- Article 12 -->
<div class="article-card" data-category="nutrition">
    <img src="https://www.tyentusa.com/blog/wp-content/uploads/2018/12/Woman-drinking-water-how-to-drink-more-water-px.jpg" alt="Hydration" class="article-image">
    <div class="article-content">
        <div class="article-meta">
            <span class="article-date">Apr 1, 2025</span>
            <span class="article-category">Nutrition</span>
        </div>
        <h3 class="article-title">Hydration: How Much Water Do You Really Need?</h3>
        <p class="article-snippet">Water is essential for nearly every bodily function, but confusion exists about optimal intake. This article explores the science of hydration and personalized recommendations.</p>
        <a href="https://www.mayoclinic.org/healthy-lifestyle/nutrition-and-healthy-eating/in-depth/water/art-20044256" target="_blank" class="btn-read">Read Article</a>
    </div>
</div>
            </div>
        </div>
